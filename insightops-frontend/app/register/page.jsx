...
export default function RegisterPage() {
  ...
  return (
    <section className="mx-auto w-full max-w-md rounded-lg border border-slate-200 bg-white/88 p-5 shadow-soft backdrop-blur dark:border-white/10 dark:bg-neutral-900/82">
      ...
      <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Register to monitor your own applications.</p>
      ...
      {message && (
        <div className="mt-4 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm text-emerald-700 dark:border-emerald-500/25 dark:bg-emerald-500/10 dark:text-emerald-300">
          {message}
        </div>
      )}
      ...
      <p className="mt-5 text-center text-sm text-slate-500 dark:text-slate-400">
        ...
        <Link href="/login" className="font-semibold text-blue-600 dark:text-blue-300">
          Sign in
        </Link>
      </p>
    </section>
